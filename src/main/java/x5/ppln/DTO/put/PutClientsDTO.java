...
public class PutClientsDTO {
    ...
    public PutClientsDTO() {
    }

    public PutClientsDTO(Integer code, String clientName, Double currentLatitude, Double currentLongitude, String favouriteColor, String favouriteCountry, Integer favouriteVintage) {
        this.code = code;
