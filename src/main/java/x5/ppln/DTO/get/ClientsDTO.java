...
public class ClientsDTO {
    ...
    public ClientsDTO(Integer code, String clientName, Double currentLatitude, Double currentLongitude, String favouriteColor, String favouriteCountry, Integer favouriteVintage) {
        this.code = code;
